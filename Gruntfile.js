    ...
    let config = {
        ...
        babel: {
            ...
            bin: {
                ...
                files: {
                    'bin/script.js': 'temp/js/script_concat.js'
                }
            },
            dist: {
                files: {
                    'dist/js/script.js': 'temp/js/script.js'
                }
            }
        },
        ...
        browserSync: {
            bsFiles: ['bin/*', 'css/style.css', '!**/node_modules/**/*'],
            options: {
                server: {
        ...
        compress: {
            main: {
                options: {
                    archive: 'bin/script.zip',
                    level: 6
                },
                files: [
                    { expand: true, cwd: 'dist/', src: ['**/*'], dest: 'materialize/' },
                    { expand: true, cwd: './', src: ['LICENSE', 'README.md'], dest: 'script/' }
                ]
            },

            src: {
                options: {
                    archive: 'bin/script-src.zip',
                    level: 6
                },
                files: [
